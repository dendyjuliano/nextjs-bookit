...
import { getAdminBookings, deleteBooking } from '../../redux/actions/booking.actions'
import { DELETE_BOOKING_RESET } from '../../redux/constants/bookingConstans'
...
const AllBookings = () => {
    ...
    const { bookings, error, loading } = useSelector(state => state.myBookings)
