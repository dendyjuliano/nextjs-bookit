...
import { newRoom, clearErrors } from '../../redux/actions/room.actions'
import { NEW_ROOM_RESET } from '../../redux/constants/roomConstans'
                    ...
                    <form className="shadow-lg" enctype="multipart/form-data" onSubmit={submitHandler}>
                        ...
                        <div className="form-check">
                            <input
                                ...
                                onChange={(e) => setAirConditioned(e.target.airConditioned)}
                            />
